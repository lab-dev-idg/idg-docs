...
export const AR_SECTIONS: Record<SpecKey, string[]> = {
  ia: [
...
export const EN_SECTIONS: Record<SpecKey, string[]> = {
  ia: [
...
export function getSections(key: SpecKey, locale: string): string[] {
  if (locale === 'ckb-IQ') {
    return CKB_SECTIONS[key] || EN_SECTIONS[key] || [];
  }
  if (locale === 'ar-IQ') {
    return AR_SECTIONS[key] || EN_SECTIONS[key] || [];
  }
  return EN_SECTIONS[key] || [];
}
