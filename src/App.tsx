...
const CKB_SECTIONS: Record<SpecKey, string[]> = {
  ia: [
    ...
    "25. گرافی زانیاری و کیانەکان",
    "26. نەخشەی ژینگەی دیجیتاڵی",
    "27. کۆنتڕۆڵی بەڵگەنامە و مێژوو"
  ],
  nav: [
    "01. فەلسەفەی ڕێنوێنی و گەشتکردن",
    "02. پێکهاتەی ڕێنوێنی سەراسەری (Global Nav)",
    "03. پێکهاتەی ڕێنوێنی دامەزراوەیی",
    "04. مۆدێلی ڕێنوێنی بەرهەمەکان (10 Nodes)",
    "05. ڕەوتی زانیاری و لۆجیکی بەکارهێنەر",
    "06. ستانداردەکانی مێگا مینیۆ (Mega Menu)",
    "07. یاساکانی ڕێڕەوی پەڕە (Breadcrumbs)",
    "08. ستراتیژی گەڕان لە ڕێنوێنیدا",
    "09. ڕێنوێنی شاشە بچووکەکان و مۆبایل",
    "10. پێداویستییەکانی دەستڕاگەیشتن (A11y)",
    "11. خێرایی و کارایی ڕێنوێنی",
    "12. توانای فراوانبوونی داهاتوو",
    "13. حوکمڕانی و کۆنتڕۆڵی ڕێنوێنی",
    "14. کۆنتڕۆڵی بەڵگەنامە"
  ],
  cts: [
    "01. بنەما جێبەجێکارییەکانی ناوەڕۆک",
    "02. تەلارسازی فرەزمان و ناوچەییکردن",
    ...
    "10. دەستڕاگەیشتن و ناوچەییکردنی میدیا",
  ...
  cmp: [
    ...
    "03. پێکهاتەکانی ڕێنوێنی و سەرپەڕە",
  ...
  api: [
    ...
    "031. تەلارسازی ئاسایشی بێ‌متمانەیی",
    ...
    "082. تەلارسازی پاکێجی گەشەپێدان (SDK)",
    ...
    "124. تەلارسازی ناوچەییکردن و زمانەکان",
    ...
    "138. تەلارسازی نموونەیی سەراسەری API",
    "139. بارودۆخی ئێستای سیستەم",
    "140. تەلارسازی ستاندارد",
    "141. تەلارسازی داهاتوو",
  ...
  knowledge: [
    ...
    "04. مەودای تەلارسازی زانیاری",
    "05. بنەما تەلارسازییە بنەڕەتییەکان",
    "06. تەلارسازی سێ زمانەی زانیاری (CKB/AR/EN)",
    "07. تەلارسازی ڕەنگدانەوەی مەنتقی (CSS Logical RTL)",
    "08. پلەبەندی زانیاری دامەزراوە (14 دۆمەین)",
    "09. سیستەمی ناساندنی بەڵگەنامە (IDG-SPEC-*)",
    "10. ستانداردی Frontmatter بە فۆرماتی YAML",
    "11. تەلارسازی گەڕانی دەقی و مانایی (Semantic)",
    "12. تەلارسازی گرافی زانیاری و کیانەکان",
  ...
  localization: [
    ...
    "13. ناوچەییکردنی پەیام و هەڵەکانی API",
  ...
  security: [
    ...
    "05. تەلارسازی بێ‌متمانەیی (Zero Trust)",
...
// Arabic localized section lists
const AR_SECTIONS: Record<SpecKey, string[]> = {
  ia: [
    "01. مبادئ معمارية المعلومات (IA)",
    "02. التسلسل الهرمي للمحتوى المؤسسي",
    "03. هيكلية ومخطط الموقع الإلكتروني",
    "04. معمارية المواقع المتعددة (Multi-site)",
    "05. فصل الكيان الأم عن المنتج 001",
    "06. ملكية المحتوى وحوكمته",
    "07. تصنيف وتصنيفية الموقع الإلكتروني",
    "08. معمارية إدارة المعرفة",
    "09. تصنيف وأنواع الصفحات",
    "10. قوالب ونماذج الصفحات",
    "11. طبقات التنقل والإبحار",
    "12. نظام البحث الشامل",
    "13. استراتيجية الروابط الداخلية",
    "14. التسلسل الهرمي للوثائق الرقمية",
    "15. تكامل الوثائق المؤسسية",
    "16. تكامل وثائق المنتجات",
    "17. استراتيجية البيانات الوصفية والوسوم",
    "18. حوكمة العناوين (URL)",
    "19. قواعد التوسع المستقبلي",
    "20. حوكمة معلومات المؤسسة",
    "21. التحكم في الإصدارات والتغييرات",
    "22. دورة حياة المحتوى",
    "23. قابلية التوسع المؤسسي",
    "24. الجاهزية للذكاء الاصطناعي (AI)",
    "25. مخطط المعرفة والكيانات",
    "26. خريطة البيئة الرقمية",
    "27. ضبط الوثائق وسجل التعديلات"
  ],
  nav: [
    "01. فلسفة التنقل والإبحار",
    "02. هيكلية التنقل الشامل (Global Nav)",
    "03. هيكلية التنقل المؤسسي",
    "04. نموذج تنقل المنتجات (10 Nodes)",
    "05. تدفق المعلومات ومنطق المستخدم",
    "06. معايير القوائم الضخمة (Mega Menu)",
    "07. قواعد مسار التنقل (Breadcrumbs)",
    "08. استراتيجية البحث في التنقل",
    "09. تنقل الشاشات الصغيرة والهواتف",
    "10. متطلبات إمكانية الوصول (A11y)",
    "11. سرعة وكفاءة التنقل",
    "12. قابلية التوسع المستقبلي",
    "13. حوكمة وضبط التنقل",
    "14. ضبط الوثيقة"
  ],
  cts: [
    "01. المبادئ التنفيذية للمحتوى",
    "02. معمارية تعدد اللغات والتوطين",
    "03. اللغات الأساسية والمستقبلية (CKB/AR/EN)",
    "04. القواعد التقنية لاتجاه RTL / LTR",
    "05. خط أنابيب الترجمة وجودة اللغة",
    "06. إدارة المصطلحات والمسارد",
    "07. مواصفات محتوى الصفحات",
    "08. معايير التحرير ونبرة العلامة",
    "09. قواعد تحسين محركات البحث (SEO)",
    "10. إمكانية الوصول وتوطين الوسائط",
    "11. دورة حياة المحتوى وحوكمته",
    "12. ضبط الوثيقة"
  ],
  seo: [
    "01. المبادئ التنفيذية لـ SEO",
    "02. استراتيجية النطاقات ومخطط URL",
    "03. SEO متعدد اللغات والمناطق",
    "04. معايير البيانات الوصفية للمؤسسة",
    "05. بنية Schema.org و JSON-LD",
    "06. معمارية خرائط الموقع (XML Sitemaps)",
    "07. سياسة برامج الزحف وروبوتات AI",
    "08. تحسين البحث الذكي (AEO & GEO)",
    "09. مؤشرات أداء الويب الأساسية (Core Web Vitals)",
    "10. حوكمة SEO ودورة المراجعة"
  ],
  ds: [
    "01. المقدمة وفلسفة التصميم",
    "02. مبادئ التصميم المؤسسي",
    "03. معمارية التصميم الذري (Atomic Design)",
    "04. نظام رموز التصميم (Design Tokens)",
    "05. معمارية الألوان واللوحات",
    "06. الخطوط والاقتران متعدد اللغات",
    "07. نظام المسافات وشبكة التصميم",
    "08. مواصفات المكونات (24 تصنيفاً)",
    "09. نقاط التجاوب وإمكانية الوصول",
    "10. نظام السمات والانعكاس المنطقي RTL"
  ],
  cmp: [
    "01. فلسفة المكونات (Component Philosophy)",
    "02. التسلسل الهرمي للمكونات الذرية",
    "03. مكونات التنقل والرؤوس",
    "04. مكونات الإجراءات والأزرار",
    "05. مكونات النماذج والإدخال",
    "06. مكونات عرض البيانات والتخطيط",
    "07. مكونات الملاحظات والنوافذ المنبثقة",
    "08. الوحدات الحكومية والمؤسسية",
    "09. معايير إمكانية الوصول (WCAG 2.2 AA)",
    "10. التدويل والمنطق ثنائي الاتجاه"
  ],
  docgov: [
    "01. رؤية ومبادئ التوثيق",
    "02. الهرم الهيكلي للمؤسسة",
    "03. هيكلية المستودعات ومعايير المجلدات",
    "04. قواعد تسمية الملفات والمجلدات",
    "05. قواعد تنسيق Markdown والبيانات الوصفية",
    "06. دورة حياة الوثائق (6 حالات)",
    "07. مصفوفة المراجعة والموافقة",
    "08. إطار التصنيف الأمني",
    "09. الترجمة متعددة اللغات والحوكمة",
    "10. سياسة AI والتوافق مع ISO 9001"
  ],
  repo: [
    "01. الملخص التنفيذي والرؤية",
    "02. المبادئ الدستورية لمستودع البرمجيات",
    "03. تصنيفات ومستويات المؤسسة",
    "04. القواعد القياسية لتسمية المستودعات",
    "05. معايير المجلدات والملفات الداخلية",
    "06. استراتيجية الفروع وقواعد GitFlow",
    "07. معايير رسائل الالتزام (Conventional Commits)",
    "08. ضوابط الأمان في GitHub Enterprise",
    "09. الملفات الأساسية الإلزامية لكل مستودع",
    "10. أنابيب الأتمتة CI/CD ودورة الحياة"
  ],
  deploy: [
    "01. ضبط الوثيقة",
    "02. الهدف ونطاق النشر",
    "03. مبادئ معمارية النشر",
    "04. نموذج النشر المؤسسي لبوابة IDG",
    "05. معمارية البيئات (7 مستويات عزل)",
    "06. معمارية نشر التطبيقات",
    "07. نشر الواجهات الأمامية والحزم الثلاثية",
    "08. نشر الواجهات الخلفية وبيئات Node/Express",
    "09. نشر API وبوابات Cloud Run",
    "10. نشر قواعد البيانات والبيانات الدائمة",
    "11. نشر البنية التحتية السحابية GCP",
    "12. نشر شبكة CDN وحواف Cloudflare",
    "13. نشر DNS والنطاقات (Anycast)",
    "14. معمارية CI/CD والأنابيب المؤتمتة",
    "15. أنابيب النشر عبر GitHub Actions",
    "16. عمليات البناء وحاويات OCI",
    "17. تعيين الفروع إلى البيئات",
    "18. نموذج الموافقة على النشر والحماية",
    "19. البنية التحتية كتعليمات برمجية (IaC Terraform)",
    "20. إدارة الأسرار والإعدادات",
    "21. إدارة متغيرات البيئة (Env Vars)",
    "22. ضوابط الأمان وفحص SAST",
    "23. إدارة الهوية والوصول (IAM)",
    "24. إدارة شهادات SSL/TLS",
    "25. المراقبة والرصد (Four Golden Signals)",
    "26. سجلات الأحداث ومسارات التدقيق",
    "27. النسخ الاحتياطي والاسترداد (PITR Recovery)",
    "28. خطة التعافي من الكوارث (DR RPO/RTO)",
    "29. استراتيجية التراجع والاسترداد التلقائي",
    "30. النشر بدون توقف (Zero-Downtime)",
    "31. استراتيجية ترحيل قواعد البيانات (Drizzle)",
    "32. إدارة التبعيات وملفات القفل",
    "33. أمان سلسلة توريد البرمجيات (SBOM)",
    "34. إدارة الثغرات الأمنية (CVSS SLA)",
    "35. حوكمة النشر والهندسة",
    "36. حوكمة الإصدارات والترقيم الدلالي",
    "37. إدارة التغييرات والإصلاحات العاجلة",
    "38. الاستجابة للحوادث وغرفة العمليات",
    "39. الأداء والتوسع التلقائي (Auto-Scaling)",
    "40. التوافر العالي والتخطيط متعدد المناطق",
    "41. الجاهزية متعددة الأقاليم (Active-Passive)",
    "42. البنية التحتية السيادية المعزولة (Air-Gapped)",
    "43. نموذج نشر المنتج 001 (AI Gate Iraq)",
    "44. نموذج نشر المنتجات المستقبلية",
    "45. علاقة مستودع الكود بعملية النشر",
    "46. دورة حياة النشر (4 حالات)",
    "47. متطلبات الامتثال والتدقيق",
    "48. مصفوفة المسؤوليات التشغيلية",
    "49. معايير تسمية النشر",
    "50. الأدلة الإرشادية لعمليات النشر",
    "51. قائمة التحقق للنشر المؤسسي",
    "52. التطور المستقبلي للنشر (2026-2028+)",
    "53. ضبط الوثيقة وسجل التعديلات"
  ],
  api: [
    "001. الملخص التنفيذي",
    "002. الأهداف والغايات",
    "003. نطاق تشغيل API",
    "004. مبادئ معمارية API",
    "005. استراتيجية API على مستوى المؤسسة",
    "006. نموذج محفظة API (المستويات 1-4)",
    "007. تصنيفية نطاقات API (16 نطاقاً)",
    "008. تصنيف مستويات API (0 إلى 4)",
    "009. معمارية API العامة",
    "010. معمارية API الخاصة",
    "011. معمارية API المشتركة",
    "012. الخدمات الداخلية (gRPC)",
    "013. التكامل الحكومي وأجهزة HSM",
    "014. واجهات برمجة المنصة",
    "015. معمارية API للمنتجات",
    "016. معمارية AI Gate Iraq (المنتج 001)",
    "017. نموذج وراثة المنتجات المستقبلية",
    "018. بوابة API (Cloudflare / Cloud Run)",
    "019. نموذج توجيه الطلبات",
    "020. معمارية المصادقة والتحقق",
    "021. التفويض والصلاحيات (RBAC / ABAC)",
    "022. توحيد الهويات (SAML / OIDC)",
    "023. معمارية OAuth 2.0 (PKCE)",
    "024. معمارية OpenID Connect",
    "025. حوكمة مفاتيح API (SHA-256)",
    "026. التحقق من خدمة إلى خدمة",
    "027. متطلبات mTLS (TLS 1.3)",
    "028. تقييد معدل الطلبات (Rate Limiting)",
    "029. الحصص والأنصبة",
    "030. ضبط التزامن وتصفية الضغط",
    "031. معمارية أمان انعدام الثقة (Zero Trust)",
    "032. الحماية من مخاطر OWASP العشرة",
    "033. التحقق من البيانات الواردة (JSON Schema)",
    "034. التحقق من البيانات الصادرة",
    "035. إدارة الأسرار (GCP Secret Manager)",
    "036. التشفير (AES-256 / CMEK)",
    "037. تصنيف مستوى حساسية البيانات",
    "038. حماية البيانات الشخصية (PII Masking)",
    "039. متطلبات سيادة البيانات",
    "040. إصدارات API (/v1/ Path Prefix)",
    "041. التوافق مع الإصدارات السابقة",
    "042. سياسة الإيقاف (مهلة 180 يوماً)",
    "043. دورة حياة API (6 مراحل)",
    "044. معايير التصميم والصياغة",
    "045. معايير REST وعمليات CRUD",
    "046. معايير بروتوكول HTTP",
    "047. معايير تنسيق JSON (snake_case)",
    "048. نموذج الأخطاء ثلاثي اللغات (CKB/AR/EN)",
    "049. معايير رموز حالة HTTP",
    "050. تقسيم الصفحات (Cursor-Based)",
    "051. التصفية والفرز",
    "052. ترتيب البيانات",
    "053. البحث في السجلات",
    "054. تكرار العمليات الآمن (Idempotency UUID)",
    "055. ربط الطلبات (X-Correlation-ID)",
    "056. التتبع الموزع (W3C Trace Context)",
    "057. المراقبة والرصد",
    "058. تسجيل البيانات (Structured JSON)",
    "059. مؤشرات الأداء (Four Golden Signals)",
    "060. نظام التنبيهات الفورية",
    "061. معايير سرعة وكفاءة API",
    "062. التوافر العالي (99.95% SLA)",
    "063. معايير الموثوقية",
    "064. التعافي من الكوارث (RPO < 5m, RTO < 15m)",
    "065. معمارية تجاوز الفشل",
    "066. معمارية API متعددة المناطق",
    "067. التكامل مع Cloudflare WAF",
    "068. التكامل مع Google Cloud Platform",
    "069. التكامل مع Firebase (Auth/Firestore)",
    "070. التكامل مع Cloud SQL (PostgreSQL 16)",
    "071. التكامل مع Cloud Run",
    "072. التكامل مع GitHub Actions",
    "073. أنبوب DevSecOps لـ API",
    "074. استراتيجية اختبار API",
    "075. اختبار العقود (Pact)",
    "076. اختبار التكامل (Integration Testing)",
    "077. اختبار الحمل والأداء (k6)",
    "078. اختبار الأمان والثغرات",
    "079. معايير توثيق API",
    "080. مواصفات OpenAPI 3.1 الرسمية",
    "081. بوابة المطورين (developer.idg.global)",
    "082. معمارية حزم SDK",
    "083. مكتبات العملاء (TS, Python, Go, Flutter)",
    "084. الإشعارات الفورية (Webhooks HMAC-SHA256)",
    "085. التكامل القائم على الأحداث (CloudEvents)",
    "086. معمارية الرسائل وقوائم الانتظار",
    "087. الربط مع الشركاء الخارجيين",
    "088. التشغيل البيني بين المؤسسات الحكومية",
    "089. تبادل بيانات API",
    "090. حوكمة API العامة",
    "091. ملكية API (CODEOWNERS)",
    "092. مراقبة وحماية API",
    "093. عملية اعتماد الواجهات",
    "094. إدارة التغييرات في API",
    "095. معايير مستودع كود API",
    "096. معايير تسمية API",
    "097. معايير تسمية نقاط النهاية",
    "098. معايير تسمية الموارد",
    "099. معايير تسمية النطاقات",
    "100. معايير مسارات URI",
    "101. معايير رؤوس الطلبات Header",
    "102. معايير نماذج ومخططات Schema",
    "103. معايير عقود API",
    "104. مراجعة أمان API",
    "105. مراجعة معمارية API",
    "106. الامتثال القانوني (ISO 27001 / SOC 2)",
    "107. إمكانية التدقيق وسجلات 7 سنوات",
    "108. معايير اتفاقية مستوى الخدمة (SLA)",
    "109. أهداف مستوى الخدمة (SLO < 100ms)",
    "110. إدارة الحوادث والمشاكل الطارئة",
    "111. المراقبة المباشرة لحالة النظام",
    "112. حوكمة تكاليف API",
    "113. تخطيط السعة والقدرة التشغيلية",
    "114. قابلية التوسع وتحمل الأحمال",
    "115. المرونة واستمرارية النظام",
    "116. معالجة حالات الأعطال",
    "117. سياسة إعادة المحاولة التلقائية (Backoff)",
    "118. قاطع الدائرة (Circuit Breaker)",
    "119. معايير انتهاء مهلة الطلبات",
    "120. عزل الأقسام (Bulkhead Isolation)",
    "121. التخزين المؤقت ومفاتيح الكاش",
    "122. استراتيجية شبكة توصيل المحتوى (CDN)",
    "123. معمارية API على الحافة (Edge API)",
    "124. معمارية التوطين واللغات",
    "125. توثيق API باتجاه اليمين إلى اليسار (RTL)",
    "126. سياسة لغة الوثائق الفنية",
    "127. تجربة المطورين (DX)",
    "128. تأهيل المطورين السريع (< 5 دقائق)",
    "129. أمثلة التعليمات البرمجية والأدلة العملية",
    "130. سجل تغييرات API",
    "131. إشعارات إيقاف الإصدارات",
    "132. الاستجابة لحوادث أمان API",
    "133. اختبار التعافي من الكوارث",
    "134. مؤشرات حوكمة API",
    "135. سجل قرارات المعمارية (ADRs)",
    "136. قائمة التحقق لامتثال API",
    "137. قائمة التحقق للجاهزية التشغيلية",
    "138. المعمارية المرجعية الشاملة لـ API",
    "139. الحالة الراهنة للنظام",
    "140. المعمارية القياسية",
    "141. المعمارية المستقبلية",
    "142. خارطة طريق تطوير API (2026-2027+)",
    "143. ضبط الوثيقة وسجل التعديلات"
  ],
  knowledge: [
    "01. ضبط الوثيقة والبيانات الوصفية",
    "02. الملخص التنفيذي",
    "03. الأهداف والغايات الأساسية",
    "04. نطاق معمارية المعرفة",
    "05. المبادئ المعمارية الجوهرية",
    "06. معمارية المعرفة ثلاثية اللغات (CKB/AR/EN)",
    "07. معمارية الانعكاس المنطقي (CSS Logical RTL)",
    "08. الهيكل الهرمي لمعرفة المؤسسة (14 نطاقاً)",
    "09. نظام تعريف الوثائق (IDG-SPEC-*)",
    "10. معيار Frontmatter بتنسيق YAML",
    "11. معمارية البحث النصي والدلالي (Semantic)",
    "12. معمارية مخطط المعرفة والكيانات",
    "13. مصفوفة الصلاحيات ومستويات الأمان",
    "14. قابلية التدقيق وسجل الوثائق (7 سنوات)",
    "15. التكامل مع المواقع والبوابات",
    "16. مؤشرات الجودة وقائمة التحقق للامتثال",
    "17. ضبط الوثيقة وسجل التعديلات"
  ],
  localization: [
    "01. ضبط الوثيقة والبيانات الوصفية",
    "02. الملخص التنفيذي",
    "03. الهدف ونطاق التوطين",
    "04. مبادئ التوطين وإدارة اللغات",
    "05. سجل المعايير القياسية للغات (BCP 47)",
    "06. معيار اختيار اللغة في الواجهات",
    "07. معمارية فصل النصوص والترجمة",
    "08. معمارية الانعكاس المنطقي (RTL/LTR)",
    "09. الخطوط والطباعة متعددة اللغات للمؤسسة",
    "10. حماية المعرفات التقنية العالمية",
    "11. التكافؤ ثلاثي اللغات ومسار التراجع",
    "12. البيانات الوصفية لـ SEO و hreflang",
    "13. توطين رسائل وأخطاء API",
    "14. إمكانية الوصول (WCAG 2.1 AA) وقارئات الشاشة",
    "15. حفظ تفضيلات المستخدم (idg.locale)",
    "16. مؤشرات الجودة وبوابة فحص CI/CD",
    "17. ضبط الوثيقة وسجل التعديلات"
  ],
  security: [
    "01. ضبط الوثيقة والبيانات الوصفية",
    "02. الملخص التنفيذي",
    "03. الهدف ونطاق الأمان",
    "04. المبادئ الأساسية للأمان السيبراني",
    "05. معمارية انعدام الثقة (Zero Trust)",
    "06. إدارة الهويات والصلاحيات (IAM/PAM)",
    "07. معايير التشفير والمفاتيح",
    "08. أمان التطبيقات وواجهات API (OWASP/CSP)",
    "09. أمان نماذج الذكاء الاصطناعي و LLM",
    "10. أمان DevSecOps وسلسلة التوريد",
    "11. مراقبة الأنظمة، SIEM والاستجابة للحوادث",
    "12. استمرارية الأعمال، DR ومؤشرات RTO/RPO",
    "13. سجل مخاطر المؤسسة والحلول المقترحة",
    "14. مواءمة الامتثال ومصفوفة RACI",
    "15. نموذج نضج الأمان (المستويات 0-5)",
    "16. مؤشرات أداء الأمان (MTTD/MTTR)",
    "17. ضبط الوثيقة وسجل التعديلات"
  ],
  data: [
    "01. ضبط الوثيقة والبيانات الوصفية",
    "02. الملخص التنفيذي",
    "03. الهدف وغايات البيانات",
    "04. المبادئ الأساسية لمعمارية البيانات",
    "05. الحالة الراهنة، المعيارية والمستقبلية للبيانات",
    "06. نطاقات وتصنيفية بيانات المؤسسة (18 نطاقاً)",
    "07. معمارية البيانات ثلاثية اللغات والثوابت",
    "08. دورة حياة البيانات ومسار الأصول (9 مراحل)",
    "09. الأمان، الخصوصية وتشفير البيانات",
    "10. حوكمة بيانات الذكاء الاصطناعي (AI Gate Iraq)",
    "11. جودة البيانات، التحقق والعقود",
    "12. التكامل، البث المباشر وأنابيب CDC",
    "13. التخزين السحابي ومعايير قواعد البيانات",
    "14. المرونة، النسخ الاحتياطي والتعافي من الكوارث",
    "15. النموذج التشغيلي للحوكمة ومصفوفة RACI",
    "16. سجل قرارات المعمارية (ADRs)",
    "17. خارطة طريق التنفيذ (2026-2027)",
    "18. مسار الامتثال والتدقيق (ISO 27001)",
    "19. الأداء، قابلية التوسع و FinOps",
    "20. ضبط الوثيقة وسجل التعديلات"
  ]
};
...
export default function App() {
  ...
  const currentSections = locale === 'ckb-IQ' 
    ...
    : (locale === 'ar-IQ' ? AR_SECTIONS[activeDoc] : EN_SECTIONS[activeDoc]);
        ...
        <div className="flex-1 p-3 overflow-hidden flex flex-col text-[11px] leading-tight">
          ...
          <nav className="flex-1 overflow-y-auto space-y-0.5 pr-1 text-slate-400 custom-scrollbar">
            <button
              ...
              className={`w-full text-start px-2.5 py-2 rounded transition flex items-center justify-between gap-2 ${
                activeSection === null
            ...
            {filteredSections.map((sec) => (
              <button
                ...
                className={`w-full text-start px-2.5 py-1.5 rounded transition flex items-center justify-between gap-2 ${
                  activeSection === sec
